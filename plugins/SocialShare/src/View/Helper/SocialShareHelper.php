...
class SocialShareHelper extends Helper
{
    ...
    public $helpers = ['Html'];
   public $app_id = '1001431253334839';
    ...
    protected $_urls = [
       ...
       // 'facebook' => 'https://www.facebook.com/sharer/sharer.php?u={url}',
        /*'facebook' => "https://www.facebook.com/dialog/feed?app_id=1001431253334839&link={url}&description={description}&name={text}&picture={image}",*/
        'facebook' => "https://www.facebook.com/dialog/feed?app_id=1880911898817872&link={url}&description={description}&name={text}&picture={image}",
