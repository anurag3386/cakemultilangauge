...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'b65uyn46257sdqeggre26j0hd31h6v6257v2157c8321h8ccf4e73772a969a9a'),
    ],
 ...
 //        ],
    ...
    // ],  
     'EmailTransport' => [
        'default' => [
            'className' => 'Smtp',
            // The following keys are used in SMTP transports
            'host' => '108.168.143.191',  //localhost
            'port' => 25,
            'timeout' => 30,
            'username' => 'services@astrowow.com',
            'password' => 'Astro@2016$',
            'client' => null,
            'tls' => false,
            'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
    ...
    'Email' => [
        'default' => [
            ...
            'from' => ['services@astrowow.com' => 'Astrowow' ],
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
