...
<!-- Google Code for AstroWOW Elite Report Orders Conversion Page -->
							...
							<div id="checkout_5" class=" et_pb_row et_pb_row_0">
								<div class="et_pb_column et_pb_column_4_4  et_pb_column_0">
									<div class="et_pb_text et_pb_module et_pb_bg_layout_light et_pb_text_align_center  et_pb_text_0">
										...
										<h2 class="intro"><?= __('Thank you, we have received your payment');?></h2>
										<p>
											<span><?= __('Please note your Order No');?>: <b><?php echo $_GET['orderid']; //echo $order_id ?></b> <?= __('and Transaction No');?>: <b><?php echo $_GET['txnid']; //echo $txnid ?></b>
											</span>
										</p>
									</div> <!-- .et_pb_text -->
								</div> <!-- .et_pb_column -->
