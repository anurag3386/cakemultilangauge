        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Title *</label>
                      <?php echo $this->Form->text('title', ['class' => 'form-control validate[required]', 'maxlength' => 255, 'onmouseout' => 'javascript:updateSeo( $(this).val() )']) ?>
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Content *</label>
                      <?php echo $this->Form->textarea('body', ['class' => 'form-control html_editor validate[required]']) ?>
                    </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label>Content *</label>
                <?php echo $this->Form->textarea('_translations.da.body', ['class' => 'form-control html_editor validate[required]']) ?>
              </div>
