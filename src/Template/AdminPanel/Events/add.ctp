               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                      <label>Date *</label>
                      <?php echo $this->Form->text('date', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
                    </div>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>
                      Time *</label>
                      <?php echo $this->Form->text('time', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
                    </div>
                  </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                      <label>Place *</label>
                      <?php echo $this->Form->text('place', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
                    </div>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                      <label>Date *</label>
                      <?php echo $this->Form->text('_translations.da.date', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
                    </div>
                  </div>
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>
                      Time *</label>
                      <?php echo $this->Form->text('_translations.da.time', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
                    </div>
                  </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group">
                      <label>Place *</label>
                      <?php echo $this->Form->text('_translations.da.place', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Description *</label>
                      <?php echo $this->Form->textarea('_translations.da.description', ['class' => 'form-control html_editor validate[required]', 'maxlength' => 500]) ?>
                    </div>
