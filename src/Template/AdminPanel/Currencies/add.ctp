  ...
  <div class="box-body">
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <div class="form-group">
          <label>Code *</label>
          <?php echo $this->Form->text('code', ['class' => 'form-control validate[required]', 'maxlength' => 20]) ?>
        </div>
      ...
      <div class="col-md-2">
        <div class="form-group">
          <label>Symbol *</label>
         <?php echo $this->Form->text('symbol', ['class' => 'form-control validate[required]', 'maxlength' => 5])?>
        </div>
