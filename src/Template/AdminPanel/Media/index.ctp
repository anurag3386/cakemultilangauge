  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border">
        ...
        <span class="add_btn">
          <a href="<?php echo $this->Url->build(['controller' => 'media', 'action' => 'add'])?>" 
            ...
            <tr>
              ...
              <td align="center">
                <span id="status_<?php echo $id; ?>">
                  <a href="javascript:changeStatus('media', <?php echo $id; ?>,<?php echo $stVal; ?>);" class="<?php echo $class; ?>">
                  <?php echo $stType; ?></a>
                </span>
              </td>
              <td align="center">
                <a class="btn btn-info btn-xs" href="<?php echo $this->Url->build(['controller' => 'media', 'action' => 'edit/'.$id])?>">
