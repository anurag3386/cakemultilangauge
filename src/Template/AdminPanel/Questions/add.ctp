							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<?php echo $this->Form->select('sun_sign_code', $sunSignOptions, ['class' => 'form-control validate[required]', 'empty' => 'Select Sunsign'] ); ?>
									</div>
								</div>	
							</div>
							<div class="row">
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<?php echo $this->Form->text('answers.'.$i.'.title', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label>Answer <?php echo ($i+1); ?> belong to sun sign</label>
											<?php echo $this->Form->select('answers.'.$i.'.sun_sign_code', $sunSignOptions, ['class' => 'form-control validate[required]', 'empty' => 'Select Answer'] ); ?>
										</div>
									</div>	
								</div>
							<?php } ?>
							...
							<?php for($i=0;$i < 3; $i++){ ?>
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											<label>Answer <?php echo ($i+1); ?>*</label>
											<?php echo $this->Form->text('answers.'.$i.'._translations.da.title', ['class' => 'form-control validate[required]', 'maxlength' => 255]) ?>
										</div>
									</div>
								</div>
							<?php } ?>
