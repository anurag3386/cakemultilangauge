...
$this->IntroductionHeader( 'HOW TO READ MY LIFE PATH REPORT & BIRTH CHART' );
...
(
 ...
 "No computer program can do this perfectly, but we do our best."
 );

$this->IntroductionHeader( 'THE DIFFERENT SECTIONS' );
$this->IntroductionParagraph
(
 "Reports from AstroWow are designed to simplify the interpretation process for you. ".
...
$this->IntroductionHeader( 'PROFESSIONAL & PERSONAL PROFILE' );
$this->IntroductionParagraph
(//MY LIFE PATH REPORT AND BIRTH CHART
 "My Life Path Report can cover your personal character, ".
...
(
 ...
 "The dynamic trends show the unfolding of the horoscope through time. ".
 "By analyzing the current trends, it is therefore possible for you to gain insight into events just past, ".
...
$this->IntroductionParagraph
(
 "This report is written by Adrian Ross Duncan, ".
