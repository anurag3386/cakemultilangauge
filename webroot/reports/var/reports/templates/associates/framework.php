<?php
  /**
   * Script: var/lib/reports/templates/associates/framework.php
   * Author: Andy Gray
   *
   * Description
 ...
 */
$page = file_get_contents(ROOTPATH.'/var/lib/reports/templates/associates/generic.html');
...
if( $isComplete === true ) {
  $page = str_replace('<!--ONLOAD_ACTIONS-->',
		      ' onLoad="javascript:goComplete();"',
		      $page);
 }

if( $isCancelled === true ) {
  $page = str_replace('<!--ONLOAD_ACTIONS-->',
		      ' onLoad="javascript:goCancelled();"',
		      $page);
 }

if( $isComplete === false && $isCancelled === false ) {
  $page = str_replace('<!--ONLOAD_ACTIONS-->',
		      ' onLoad="javascript:goStart();"',
		      $page);
 }
