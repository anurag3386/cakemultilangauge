<?php
  ...
  require_once ( ROOTPATH .'helper/nets/nets.post.class.php');
	$ReturnURL = array("12" => SUCCESS_URL_RPT_CAD, 
			"13" => SUCCESS_URL_RPT_CL,
			"14" => SUCCESS_URL_RPT_AC, 
			"16" => SUCCESS_URL_RPT_PA, 
			"17" => SUCCESS_URL_RPT_CAV, 
			"18" => SUCCESS_URL_RPT_CH, 
			"21" => SUCCESS_URL_RPT_EYAP);
	...
	$OKURL = $ReturnURL[$Items["ProductId"]];								/*  "http://wpclone.astrowow.com/thank-you.php";   */
