<?php
	...
	$ReturnURL = array("7" => SUCCESS_URL_HI, 
			"8" => SUCCESS_URL_AFL,
			"9" => SUCCESS_URL_AC, 
			"7-RS" => SUCCESS_URL_HI_RS, 
			"8-RS" => SUCCESS_URL_AFL_RS, 
			"9-RS" => SUCCESS_URL_AC_RS);
	...
	$OKURL = $ReturnURL[$Items["ProductId"].$Items["ProductType"]];		/*  "http://wpclone.astrowow.com/thank-you.php";   */
