...
class paypal_class {
    ...
    function paypal_class() {
        ...
        //$this->add_field('cmd','_xclick-subscriptions');  //ITS FOR SUBSCRIPTION        
    }
    ...
    function validate_ipn() {
        ...
        if (preg_match('/RECEIVED/', $this->ipn_response)) {
            // Received Payment
            $this->log_ipn_results(true);
            return true;
        }
        //else if (eregi("INVALID",$this->ipn_response)) {
        if (preg_match('/INVALID/', $this->ipn_response)) {
             // Invalid IPN transaction.  Check the log for details.
            $this->last_error = 'IPN Validation Failed.';
            $subject = 'Paypal IPN Gateway - '. $this->last_error . " = " . $this->ipn_response;
            $to = $this->admin_email;
