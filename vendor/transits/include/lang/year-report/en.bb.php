...
//$IntroductionText['en'][1] = 'YOUR ESSENTIAL YEAR REPORT';		
$IntroductionText['en'][1] = 'MY YEAR AHEAD';		//My Year Ahead
...
$IntroductionText['en'][3] = "Each individual has then a unique life that can be mapped astrologically according to the planetary movements after birth. The My Year Ahead Report synthesizes three astrological methods to map the life journey of the individual:";
...
$IntroductionText['en'][7] = 'This synthesis is complex. With 12 signs, 12 houses and 10 planets (with Sun and Moon) there are 1440 simple combinations. When the connection between planets are taken into consideration (aspects) and then transits and progressions, there are several hundred thousand combinations. The My Year Ahead Report works on several thousand of these, the rest needs to be filled in with your memory and creative visualization. For those interested in the astrological detail, each influence is annotated in the report, and you can see these influences at the end of the report. You can also read more about the basics of astrology at the end of the report. Please bear in mind, that with such complexity, contradictions can arise, and these will generally show either different parts of your character, or contradictory events which happen at the same time.';
$IntroductionText['en'][8] = 'This reading describes your own evolutionary journey. To understand it fully you need to understand the talents and challenges that the planetary positions at birth represent. The first part of every section of the My Year Ahead Report explains therefore what you can expect in life based on who you are as a person. It is crucial to realize that what happens during the course of the life is constrained by these personal factors. If your love life promises great happiness, then later trends will trigger this potential... and vice versa.';
$IntroductionText['en'][9] = 'If you wish to know more in detail about your personal character and how to get the most out of your life, then our My Life Path Report & Birth Chart will go into this deeply. The My Year Ahead Report is designed to map out the timing of events and the fulfillment of your destiny.';
$IntroductionText['en'][10] = 'You may notice contradictions in your report; these reflect your complex personality. For instance, you may be a wallflower in certain situations, but other circumstances might bring out your chatty side. While your chart may provide helpful insights, it cannot predict the future. You are ultimately the master of your own fate.';
$IntroductionText['en'][11] = 'ABOUT THE AUTHOR';
$IntroductionText['en'][12] = 'This report is written by Adrian Ross Duncan, former editor of the Astrological Association Journal, who has worked as a full time astrologer since 1985. Adrian is author of "Doing Time on Planet Earth" (Element Books 1990) and "Astrology: Transformation and Empowerment" (Red Wheel/Weiser 2002). His astrology software Horoscope Interpreter, Astrology for Lovers, and The Astrological Calendar, and much more, are available from www.astrowow.com';
...
$GenericText['en']['ReportTitle'] = 'My Year Ahead';
$GenericText['en']['ReportDesign'] = 'written and designed by Adrian Duncan';

$GenericText['en']['CoverReportForLabel'] = 'My Year Ahead';
