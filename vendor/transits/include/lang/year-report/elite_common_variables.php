...
$ThemePageArray['CoverPage'] = ROOTPATH . '/bin/pages/year_report_theme/Elite_Instroduction.pdf';
//$ThemePageArray['CoverPage'] = ROOTPATH . '/bin/pages/year_report_theme/Instroduction.pdf';

$ThemePageArray['Default'] = ROOTPATH . '/bin/pages/year_report_theme/1_LifePath_BG.pdf';
$ThemePageArray['Default_BG'] = ROOTPATH . '/bin/pages/year_report_theme/1_LifePath_BG.pdf';

$ThemePageArray['LifePath'] = ROOTPATH . '/bin/pages/year_report_theme/1_LifePath.pdf';
$ThemePageArray['LifePath_BG'] = ROOTPATH . '/bin/pages/year_report_theme/1_LifePath_BG.pdf';

$ThemePageArray['Career'] = ROOTPATH . '/bin/pages/year_report_theme/2_Career.pdf';
$ThemePageArray['Career_BG'] =ROOTPATH . '/bin/pages/year_report_theme/2_Career_BG.pdf';

$ThemePageArray['PersonalDevelopment'] = ROOTPATH . '/bin/pages/year_report_theme/3_PersonalDevelopment.pdf';
$ThemePageArray['PersonalDevelopment_BG'] = ROOTPATH . '/bin/pages/year_report_theme/3_PersonalDevelopment_BG.pdf';

$ThemePageArray['FeelingsAndSecurity'] = ROOTPATH . '/bin/pages/year_report_theme/4_FeelingsAndSecurity.pdf';
$ThemePageArray['FeelingsAndSecurity_BG'] = ROOTPATH . '/bin/pages/year_report_theme/4_FeelingsAndSecurity_BG.pdf';

$ThemePageArray['MentalDevelopment'] = ROOTPATH . '/bin/pages/year_report_theme/5_MentalDevelopment.pdf';
$ThemePageArray['MentalDevelopment_BG'] = ROOTPATH . '/bin/pages/year_report_theme/5_MentalDevelopment_BG.pdf';

$ThemePageArray['ValuesLoveAndRelationships'] = ROOTPATH . '/bin/pages/year_report_theme/6_ValuesLoveAndRelationships.pdf';
$ThemePageArray['ValuesLoveAndRelationships_BG'] = ROOTPATH . '/bin/pages/year_report_theme/6_ValuesLoveAndRelationships_BG.pdf';

$ThemePageArray['WillpowerAndAssertion'] = ROOTPATH . '/bin/pages/year_report_theme/7_WillpowerAndAssertion.pdf';
$ThemePageArray['WillpowerAndAssertion_BG'] = ROOTPATH . '/bin/pages/year_report_theme/7_WillpowerAndAssertion_BG.pdf';

$ThemePageArray['CollectiveTrends'] = ROOTPATH . '/bin/pages/year_report_theme/8_CollectiveTrends.pdf';
$ThemePageArray['CollectiveTrends_BG'] = ROOTPATH . '/bin/pages/year_report_theme/8_CollectiveTrends_BG.pdf';
