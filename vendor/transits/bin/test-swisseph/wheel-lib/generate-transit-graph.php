...
/**
 * http://jpgraph.net/download/manuals/chunkhtml/ch15.html#fig.example17
 * http://jpgraph.net/download/manuals/chunkhtml/ch14s10.html
 *
 * @name: generate-transit-graph.php
 * @package: TransitGraph
 *
 *
 * Modify on 25-Now-2010
 *
 * @copyright: World-Of-Wisdom and Amit Parmar <parmaramit1111@gmail.com>
 */
//http://www.astrolog.org/ftp/README.540
//Astrolog Help
...
class GenerateTransitGraph extends CommonPDFHelper {
	...
	function GenerateTransitGraph($birthDTO, $ordDate) {		
...
//        $this->startEnd = 2011;
		...
		/* look for transits */
		//For Previous Year
		//$astrologService->calcDynamicAspects($birthDTO, 2009, 3);		
		$astrologService->calcDynamicAspects($birthDTO, $this->startYear - 1, 4);
		
		//Sort transit removes the duplicate entry sor dont need to sort the transit
		//$this->sortTransits($astrologService);		
...
// 				if($transiting_planet == '1005' && $natal_planet == '1000' && isset($startEndDate['start']) && isset($startEndDate['end'])){
// 					echo "<pre> $transiting_planet = $natal_planet<br /> ";
// 					print_r($startEndDate);
// 					echo "</pre>";
// 				}
		...
		//Sort Crossings removes the duplicate entry sor dont need to sort the transit
		//$this->sortCrossings($astrologService);
