...
class FinalBundleGeneraterPDF extends fpdi {
	...
	function FinalBundleGeneraterPDF() {
		...
		if($Global_Language == "dk") {
			$this->SupplementaryPlanetTemplate = ROOTPATH.'/var/reports/dk/Planets_dk.pdf';
			$this->SupplementarySignTemplate = ROOTPATH.'/var/reports/dk/Signs_dk.pdf';
			$this->SupplementaryHouseTemplate = ROOTPATH.'/var/reports/dk/Houses_dk.pdf';
			$this->SupplementaryAspectTemplate = ROOTPATH.'/var/reports/dk/Aspects_dk.pdf';			
		}elseif($Global_Language == "sp"){
			
			$this->SupplementaryPlanetTemplate = ROOTPATH.'/bin/pages/sp_planets.pdf';
			$this->SupplementarySignTemplate   = ROOTPATH.'/bin/pages/sp_signs.pdf';
			$this->SupplementaryHouseTemplate  = ROOTPATH.'/bin/pages/sp_houses.pdf';
			$this->SupplementaryAspectTemplate = ROOTPATH.'/bin/pages/sp_aspects.pdf';
...
//        $this->AddProgressedAspectContentPage();
	...
	function Explanation() {
		...
		echo $this->SupplementaryPlanetTemplate ."<br />";
