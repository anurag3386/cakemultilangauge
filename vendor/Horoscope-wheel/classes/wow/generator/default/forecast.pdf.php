...
class PDF_Forecast extends Forecast {
  ...
  function PDF_Forecast() {
    ...
    $this->chapter_heading_line_height	= 9;
    ...
    $this->section_heading_font_size	= 10;
    $this->section_heading_font_colour	= array( 0x00, 0x00, 0x00 );
    $this->section_heading_line_height	= 5;
    ...
    $this->section_content_font_size	= 10;
    $this->section_content_font_colour	= array( 0x00, 0x00, 0x00 );
    $this->section_content_line_height	= 4;
