...
// 			$StartDate = $this->getSectionHeaderObject( $sectionContent );
// 			$EndDate =$this->getSectionHeaderObject( $sectionContent );
			echo "<pre>$sectionContent == $sIndex, $oIndex, $cIndex </pre>";
