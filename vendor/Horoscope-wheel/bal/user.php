...
if (!class_exists('genericMail')) {
	require_once(ROOTPATH."helper/mail/genericMail.php");
}
...
class User {
	...
	function GetUserCityInfo ($country, $city) {
		$userRepository = new UserRepository();
		$returnValue = $userRepository->GetUserCityInfo($country, $city);
		return $returnValue;
	}
...
// 		exit;
	...
	public function GetUserDetail($user_id, $user_type) {
		$userRepository = new UserRepository();
		$returnValue = $userRepository->GetUserDetail($user_id, $user_type);
		return $returnValue;
	}

	public function GetUserBirthDetailByUserId($user_id) {
		$userRepository = new UserRepository();
		$returnValue = $userRepository->GetUserBirthDetailByUserId($user_id);
		return $returnValue;
	}
