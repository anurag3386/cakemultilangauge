...
class PDF_Wheel extends PDF_Bookmark {
    ...
    function drawTableUserInfo( $lang ) {
        ...
        //echo 'Here => '.$this->table_user_info_fname; die;
        ...
        */
        ...
        $this->MultiCell(
                ...
                iconv("UTF-8", "windows-1252", $this->table_user_info_fname), // To handle special characters in pdf file
                0, 2, 'C', 0
        );
        // lname
        $this->SetXY(
        ...
        $this->Cell(
                ...
                //sprintf("%s: %s", 'Time Zone', $this->table_user_info_birth_timezone),
                0, 2, 'C', 0
        );
        // Summertime;
        $this->SetXY(
        ...
        $this->Cell(
                ...
                //sprintf("%s: %s", 'Summer Time', $this->table_user_info_birth_summertime),
                0, 2, 'C', 0
        );
    ...
    function drawTableSymbolInfo( $lang ) {
        ...
        if ($lang == 'en') {
            /*$wheel_info_symbols[$lang] = array(
                'Sol','Luna',
                'Mercurio','Venus','Marte',
                 utf8_decode('Júpiter'),'Saturno',
                'Urano','Neptuno',utf8_decode('Plutón'),
                'Nodo Norte','Nodo Sur',
                'Aries','Tauro',utf8_decode('Géminis'),'Cancer',
                'Leo','Virgo','Libra',utf8_decode('Escorpión'),
                'Sagitario','Capricornio','Acuario','Piscis',
                utf8_decode('Conjunción'),'Semisextil','Semicuadratura','Sextil','Cuadratura',
                utf8_decode('Trigono'),'Sesquicuadratura','Quincuncio',utf8_decode('Oposición'),
                'Ascendente','Descendente','Medium Coeli','Immum Coeli',
                'Retrogrado'
            );*/
