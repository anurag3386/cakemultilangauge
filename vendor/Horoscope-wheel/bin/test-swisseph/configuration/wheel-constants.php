...
$planets = array('Sun', 'Moon', 'Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 
        'NNode', 'SNode', 'Ascendant', 'MC', 'IC', 'Descendant');
...
$asp_color[1] = isset( $blue ) ? $blue : '';
$asp_color[2] = isset( $red) ? $red : '';
$asp_color[3] = isset( $green) ? $green : '';		
$asp_color[4] = isset( $red ) ? $red : '';			//$magenta;
$asp_color[5] = isset( $blue ) ? $blue : '';			//$cyan;
$asp_color[6] = isset( $green ) ? $green : '';			//$orange;

$asp_name[1] = "Con";               //Conjunction
$asp_name[2] = "Opp";               //Opposition
$asp_name[3] = "Tri";               //Trine
$asp_name[4] = "Squ";               //Square
$asp_name[5] = "Qui";               //Quincunx
$asp_name[6] = "Sex";               //Sextile
