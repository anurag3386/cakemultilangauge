...
echo "\n YearReport:: Checking queued order | \n";
/*
...
//$orderQueueList = $orderDAL->GetList( array( array( 'order_id', '=', 33567 ) ) );           // Amit Parmar
...
//          	Creating Email Objects
            ...
            echo "\n [USEREMAIL:" . $orderitem->email_id. "] \n";
            echo "\n<pre>Email is Sent [ORDERNO:".$orderitem->order_id."]</pre>\n";
            $TableOfContent = array();
        }
    }
}
