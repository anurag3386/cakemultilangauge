...
//This variable just for testing purpose please make it dyanamic
$affiliate_id='2';
...
$orderQueueList = $orderDAL->GetList ( array(
                        ...
                        array ('delivery_option', '=', 3),                                          /* Only Email Version */
                        array ('product_type', '=', 4),                                             /* Only Email Version */
                        array ('product_item_id', '=', "19"),                                       /* YEAR REPORT */
                    ) );

//$orderQueueList = $orderDAL->GetList( array( array( 'order_id', '=', 1522 ) ) );                   // Sir Age
//$orderQueueList = $orderDAL->GetList( array( array( 'order_id', '=', 1616 ) ) );                   // James Duncan
//$orderQueueList = $orderDAL->GetList( array( array( 'order_id', '=', 232 ) ) );                   // James Duncan
...
if (count($orderQueueList) > 0) {
    ...
    foreach ($orderQueueList as $orderitem) {
    	...
    	/** Below code is commented due to invalid language */
    	/* 
        ...
        */
        ...
        echo "<pre>ORDERNO:-:$orderitem->order_id</pre>";
        ...
        if(count($birthDataObj) > 0) {
            ...
            echo "<pre>AGE:: $UserAge</pre>";
            $astrologService = new AstrologServices($birthDTO);
            echo "<pre>Wheel Start</pre>";
...
function DeleteUnwantedFile($SPOOLPATH, $OrderNumber) {
    ...
    //if (file_exists($DeleteBundleFile))   {     unlink ($DeleteBundleFile);   }
}
?>