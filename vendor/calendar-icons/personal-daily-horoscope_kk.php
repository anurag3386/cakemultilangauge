            ...
            $calendarResponse .= "<div class='tabify04-outer'>
        		<ul id='tabbed04' class='tabify04'>
                    ...
                    if (isset($monthhh1) && !empty($monthhh1)) {
        		      $calendarResponse .= "<li data-mod='".$monthLimit."' class='tablinks' onclick='tabbed_calendar(1, ".$monthLimit.")' ref='1' style='display: none;'>".ucfirst($monthhh1)."</li>";
                    }
                    ...
                    $calendarResponse .= "<li class='nextMonth' onclick='15242688001524268800(2, ".$monthLimit.")' ref='2'> <img src=".BASEURL."webroot/img/right.png> </li>
            ...
            for ($i=0; $i<($maxday+$startday); $i++) {
                ...
                if($i < $startday) {
        			...
        			if(($i % 7) == 6 ) {
                        ...
                        //if( $_SERVER['REMOTE_ADDR'] == '103.254.97.14' || $_SERVER['REMOTE_ADDR'] == '103.248.117.12' ) {
                            $dateWithLink = '04-26-2017';
                            if (dateFormating($dateWithLink) >= $_SESSION['calendar_start_date'] && $_SESSION['calendar_end_date'] >= dateFormating($dateWithLink)) {
                                //die ('yes');
                                $calendarResponse .= "<a class='lnkDaily' onclick='button_onClick($dateWithLink1)' id='".$dateWithLink."' href='javascript:void(0);' >";
                            } else {
                                //echo dateFormating($dateWithLink).' => '.$_SESSION['calendar_start_date'].' => '.$_SESSION['calendar_end_date'].'<br><br><br>';
                                //die ('No');
